...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Modulnformativo moduloreporte = new Modulnformativo();
				moduloreporte.show();
				dispose();
		...
		JButton btnNewButton_2 = new JButton("Anallizador de Logs");
		...
		JButton btnNewButton_3 = new JButton("Atencion de Incidentes con ChatGPT");
		...
		btnNewButton_3.setBounds(6, 272, 339, 52);
		...
		JLabel lblNewLabel = new JLabel("Bienvenido al SIEM Ucaldas");
		lblNewLabel.setForeground(Color.BLACK);
		lblNewLabel.setBounds(38, 22, 346, 27);
